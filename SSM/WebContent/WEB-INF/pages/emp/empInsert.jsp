...
<div class="col-md-12">
	<section class="panel">
		<header class="panel-heading">
			<span class="label label-primary">添加员工信息</span> <span class="tools pull-right"> </span>
		</header>
		<div class="panel-body">
<form novalidate="novalidate" class="form-horizontal tasi-form" 
	...
	<div class="form-group">
		...
		<div class="col-md-3 col-xs-11">
			<input name="sex" checked="checked" value="男" type="radio">
	...
	<div class="form-group">
		...
		<div class="col-md-3 col-xs-11">
			<select name="role" id="authority" 
			class="form-control form-control-inline input-medium default-date-picker" 
			style="width:180px;">
			    <option selected="selected" value="普通员工">普通员工</option>
